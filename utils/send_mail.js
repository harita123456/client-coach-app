...
const sendOtpCode = async (data) => {
  try {
    ...
    <body>
        <div class="container">
            <div class="logo-area">
                <img src="https://gcdnb.pbrd.co/images/9ekZ6JlUxcVl.png" alt="Logo" class="logo-img">
                <span class="app-name">FitCoach</span>
            </div>
            <div class="content">
                <h1 class="greeting">
                ...
                <p class="text">
                    We received a request to reset your password for your FitCoach account. To ensure the security of your account, please use the verification code below:
                </p>
                <div class="otp-code">
                ...
                <p class="text">
                    This code will expire in 10 minutes. If you didn't request this password reset, please ignore this email or contact our support team immediately at
                    <a href="mailto:${process.env.MAIL_FROM_ADDRESS}" class="support-link">${process.env.MAIL_FROM_ADDRESS}</a>.
                </p>
                <p class="text">
                    For your security, please create a strong password that you haven't used before.
                </p>
                <div class="team-signature">
                    Best regards,<br>
                    <span>The FitCoach Team</span>
                </div>
                <div class="footer">
